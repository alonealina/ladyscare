...
<div class="category_div">
    ...
    <form name="regist_form" action="{{ route('member_comp') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="buy_btn_flex" style="width: 40vw; margin: 1vw auto;">
            <a href="#!" class="buy_btn_white" style="padding: 1.25vw; margin: 1vw auto; width:19vw;">反映しないで確定</span></a>
            <a href="#!" class="buy_btn_black" style="padding: 1.25vw; margin: 1vw auto; width:19vw;">反映して確定</a>
        </div>
