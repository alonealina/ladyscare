...
<div class="category_div">
    ...
    <form name="regist_form" action="{{ route('mypage') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="buy_btn_flex" style="width: 40vw; margin: 1vw auto;">
            <a href="{{ route('mypage') }}" class="buy_btn_white" style="padding: 1.25vw; margin: 1vw auto; width:19vw;">反映しない</span></a>
            <a href="{{ route('mypage') }}" class="buy_btn_black" style="padding: 1.25vw; margin: 1vw auto; width:19vw;">反映する</a>
        </div>
...
<form name="regist_form" action="{{ route('mypage') }}" method="post" enctype="multipart/form-data">
    ...
    <a href="{{ route('mypage') }}" class="send_btn send_btn_white" style="margin:10px auto 20px;">反映しない</a>
    <a href="{{ route('mypage') }}" class="send_btn" style="margin:20px auto;">反映する</a>
</form>
