...
<div class="category_div">
    ...
    <div class="popup_red skip_after_red">次回のお届けは0000年00月00日になります</div>
    <a class="subsc_item_btn_w skip_after_btn">お届けスキップ済み</a>
...
<div class="popup_red skip_after_red">次回のお届けは0000年00月00日になります</div>
<a href="#!" onclick="clickSkipBtn()" class="send_btn send_btn_white skip_after_btn" style="margin:10px auto 20px;">お届けスキップ済み</a>
